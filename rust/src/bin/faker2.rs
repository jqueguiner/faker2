...
const FORMATTERS: &[&str] = &[
    "name", "first_name", "last_name", "prefix", "suffix", "address",
    "street_address", "street_name", "city", "state", "state_abbr", "postcode",
    "country", "email", "free_email", "user_name", "domain_name", "url", "ipv4",
    "mac_address", "word", "sentence", "paragraph", "company", "company_suffix",
    "catch_phrase", "bs", "phone_number", "color_name", "hex_color", "uuid4",
];
