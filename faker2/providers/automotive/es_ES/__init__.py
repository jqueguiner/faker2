...
class Provider(AutomotiveProvider):
    ...
    .. |license_plate_unified| replace::
       :meth:`license_plate_unified() <faker2.providers.automotive.es_ES.Provider.license_plate_unified>`

    .. |license_plate_by_province| replace::
       :meth:`license_plate_by_province() <faker2.providers.automotive.es_ES.Provider.license_plate_by_province>`
    """
