...
class Provider(AutomotiveProvider):
    ...
    .. |license_plate_car| replace::
       :meth:`license_plate_car() <faker2.providers.automotive.nl_NL.Provider.license_plate_car>`

    .. |license_plate_motorbike| replace::
       :meth:`license_plate_motorbike() <faker2.providers.automotive.nl_NL.Provider.license_plate_motorbike>`
    """
