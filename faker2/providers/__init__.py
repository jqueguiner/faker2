...
class BaseProvider:
    ...
    def random_choices(
        ...
        :meth:`random_elements() <faker2.providers.BaseProvider.random_elements>` which
    ...
    def numerify(self, text: str = "###") -> str:
        ...
        Under the hood, this method uses :meth:`random_digit() <faker2.providers.BaseProvider.random_digit>`,
        :meth:`random_digit_not_null() <faker2.providers.BaseProvider.random_digit_not_null>`,
        :meth:`random_digit_or_empty() <faker2.providers.BaseProvider.random_digit_or_empty>`,
        and :meth:`random_digit_not_null_or_empty() <faker2.providers.BaseProvider.random_digit_not_null_or_empty>`
    ...
    def bothify(self, text: str = "## ??", letters: str = string.ascii_letters) -> str:
        ...
        Under the hood, this method uses :meth:`numerify() <faker2.providers.BaseProvider.numerify>` and
        and :meth:`lexify() <faker2.providers.BaseProvider.lexify>` to generate random values for number
