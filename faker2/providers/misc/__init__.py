...
from faker2.exceptions import UnsupportedFeature
...
class Provider(BaseProvider):
    ...
    def dsv(
        ...
        **fmtparams: Any,
        ...
        string tokens will be passed to  :meth:`pystr_format() <faker2.providers.python.Provider.pystr_format>`
    ...
    def csv(
        ...
        :meth:`dsv() <faker2.providers.misc.Provider.dsv>` which is used under the hood.
    ...
    def json_bytes(
        ...
        :meth:`json() <faker2.providers.misc.Provider.json>` which is used under the hood.
        """
