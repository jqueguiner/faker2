...
class Provider(BarcodeProvider):
    ...
    .. |JaJpProvider.localized_ean| replace::
       :meth:`JaJpProvider.localized_ean() <faker2.providers.barcode.ja_JP.Provider.localized_ean>`

    .. |JaJpProvider.localized_ean8| replace::
       :meth:`JaJpProvider.localized_ean8() <faker2.providers.barcode.ja_JP.Provider.localized_ean8>`

    .. |JaJpProvider.localized_ean13| replace::
       :meth:`JaJpProvider.localized_ean13() <faker2.providers.barcode.ja_JP.Provider.localized_ean13>`
    """
